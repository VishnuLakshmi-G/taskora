...
def update_task(task_id: int):
    try:
        ...
        # Track original status to check if completion notification needed
        ...
        # If status changed to completed, set confirmation_status to pending for admin review
        # (unless it's already approved)
        if task.status == "completed" and task.confirmation_status != "approved":
